...
$(window).scroll(function() {
    ...
    let scrollBox = $(".statistics").offset().top - 800;
    if (scroll >= scrollBox) {
        $(".skill__inner-bar").addClass("active-animat");
    }
});
